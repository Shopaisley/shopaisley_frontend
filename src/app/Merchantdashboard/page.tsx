...
<Flex style={{
    ...
    <Flex pos={"relative"} right={"-60px"} top={"41px"}>
    <Input width='503px' placeholder='Search' />

    </Flex>

    <Flex color="black" fontWeight={"bold"}  fontSize={"20px"} pos={"relative"} top={"41px"} right={"-397px"}>
        <p>User</p>
    </Flex>
